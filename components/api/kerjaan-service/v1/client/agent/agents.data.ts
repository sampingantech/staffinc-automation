    ...
    createAgent(branchId = 1823, payrollGroupId=1742) {
        return {
            ...
            employment_data: {
                ...
                end_date: "2025-09-12",
                external_id: "3124345123", // di bikin random aja
                privy_id: "43534345112", // di bikin random aja
                project_ids: [
                    1753
                ],
            ...
            personal_data: { // ini hardcode aja
                ...
                citizenship_number: "1234567890123456", // di bikin random aja
                city_id: 720,
